                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label>Monto</label>
                                                    <input class="input form-control input-sm" type="number" step="0.01" name="monto" id="monto" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class=" form-control input-sm " name="curso[]" id="curso[]" size="15" multiple>
                                                        <optgroup label="Diplomados">
                                                            ...
                                                            <option value="37">Diplomado de familia, violencia familiar y trata de persona</option>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input form-control input-sm" type="text" rows="12" name="observaciones" id="observaciones" placeholder=""></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
